...
We will construct the triangulation mesh based on the national (admin0) borders of the country of interest. It is possible to manipulate the mesh resolution by setting the arguments max.edge and offset accordingly. 
