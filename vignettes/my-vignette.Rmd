...
## DATA PREPARATION
The survey data set consists of both demographic and geographic components. The demographic data contains the responses of the participants to the survey. The data set includes a variable indicating the corresponding cluster ID of each data row, which takes place in the geographic part as well.   
