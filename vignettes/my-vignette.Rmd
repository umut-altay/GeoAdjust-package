...
The random displacement causes the observed coordinates to contain positional error. We recently discovered that this leads attenuation in the parameter estimates towards zero together with poor predictive performance [@altay2022accounting], [@altay2022covariates]. This package aims to provide fast and useful tools that allow doing inference and prediction while adjusting/accounting for the positional error in the GPS coordinates of the survey cluster centers.
