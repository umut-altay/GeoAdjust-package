...
smallGeo = data.frame(clusterIdx = clusterLevel$DHSCLUST, urban = clusterLevel$URBAN_RURA,
                      long = as.vector(clusterLevel@coords[,1]), lat = as.vector(clusterLevel@coords[,2]),
                      admin1 = clusterLevel$ADM1NAME)
...
At this point the data frame "nigeria.data" should contain the variables that will be needed further in the analysis. Construction of this data frame was only for illustration purposes and it will not be used. Instead we will use an example data se  
