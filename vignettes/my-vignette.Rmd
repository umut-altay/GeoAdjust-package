...
```{r eval=FALSE}
# (Running the code chunk below line by line might cause "plot.new has not been called yet" error.
# Instead try selecting all four lines and running them at once.)
